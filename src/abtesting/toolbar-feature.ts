...
import * as B_GenerateButtonHtml from '../toolbar2/item/render-button';
...
export let generateButtonHtml = (isA) ? A_GenerateButtonHtml.generateButtonHtml : B_GenerateButtonHtml.renderButton;
