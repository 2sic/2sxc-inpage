...
import * as B_GenerateToolbarHtml from '../toolbar2/generate-toolbar-html';
...
export let generateToolbarHtml = (isA) ? A_GenerateToolbarHtml.generateToolbarHtml : B_GenerateToolbarHtml.generateToolbarHtml;
