...
var instance_config_1 = __webpack_require__(40);
var ng_dialog_params_1 = __webpack_require__(41);
var qucik_dialog_config_1 = __webpack_require__(42);
var user_of_edit_context_1 = __webpack_require__(43);
/**
...
var ab_testing_config_1 = __webpack_require__(39);
...
var render_1 = __webpack_require__(7);
var quick_dialog_1 = __webpack_require__(8);
var command_link_to_ng_dialog_1 = __webpack_require__(34);
/**
...
Object.defineProperty(exports, "__esModule", { value: true });
var command_create_1 = __webpack_require__(32);
/**
...
Object.defineProperty(exports, "__esModule", { value: true });
var command_create_1 = __webpack_require__(32);
var command_execute_action_1 = __webpack_require__(54);
var command_initialize_instance_commands_1 = __webpack_require__(6);
var command_link_to_ng_dialog_1 = __webpack_require__(34);
...
exports.ensureDefinitionTree = function (original, toolbarSettings) {
    ...
    toolbarConfig.settings = Object.assign({}, exports.defaultToolbarSettings, original.settings, toolbarSettings);
    // todo: old props, remove
...
Object.defineProperty(exports, "__esModule", { value: true });
var create_1 = __webpack_require__(58);
/**
 ...
 * @param toolbarSettings
 */
var ensureDefinitionTree = function (original, toolbarSettings) {
    // original is null/undefined, just return empty set
    if (!original)
        throw ("preparing toolbar, with nothing to work on: " + original);
    // ensure that if it's just actions or buttons, they are then processed as arrays with 1 entry
    ...
    toolbarConfig.items = original.groups || []; // the groups of buttons
    toolbarConfig.params = original.params || {}; // these are the default command parameters
    toolbarConfig.settings = Object.assign({}, defaultToolbarSettings, original.settings, toolbarSettings);
    // todo: old props, remove
    toolbarConfig.name = original.name || 'toolbar'; // name, no real use
    toolbarConfig.debug = original.debug || false; // show more debug info
    toolbarConfig.defaults = original.defaults || {}; // the button defaults like icon, etc.
...
Object.defineProperty(exports, "__esModule", { value: true });
var i18next = __webpack_require__(36);
var i18nextXHRBackend = __webpack_require__(37);
var jqueryI18next = __webpack_require__(38);
/**
