...
var command_definition_1 = __webpack_require__(37);
...
var user_of_edit_context_1 = __webpack_require__(40);
/**
...
var sxc_1 = __webpack_require__(5);
...
function removeDisableButtons(context, full) {
...
function disableButtons(context, btns) {
    for (var i = 0; i < btns.length; i++) {
        ...
        if (btns[i].action) {
            btns[i].disabled = evalPropOrFunction(btns[i].disabled, context, btns[i].action.params, false);
        }
        else {
...
function evalPropOrFunction(propOrFunction, context, settings, fallback) {
...
Object.defineProperty(exports, "__esModule", { value: true });
var render_groups_1 = __webpack_require__(62);
...
Object.defineProperty(exports, "__esModule", { value: true });
var old_parameters_adapter_1 = __webpack_require__(63);
var render_helpers_1 = __webpack_require__(23);
/**
...
Object.defineProperty(exports, "__esModule", { value: true });
var sxc_1 = __webpack_require__(5);
var cmds_strategy_factory_1 = __webpack_require__(80);
var mod_1 = __webpack_require__(81);
...
var command_execute_action_1 = __webpack_require__(59);
var commands_1 = __webpack_require__(6);
...
Object.defineProperty(exports, "__esModule", { value: true });
var command_1 = __webpack_require__(58);
/**
 * assemble an object which will store the configuration and execute it
 * @param sxc
 * @param editContext
...
function commandCreate(context, specialSettings) {
    var ngDialogUrl = context.sxc.sxcRootUrl +
        'desktopmodules/tosic_sexycontent/dist/dnn/ui.html?sxcver=' +
        context.sxc.version;
    var isDebug = window.$2sxc.urlParams.get('debug') ? '&debug=true' : '';
    var cmd = new command_1.Command(context, specialSettings, ngDialogUrl, isDebug);
    return cmd;
}
...
Object.defineProperty(exports, "__esModule", { value: true });
var coords_1 = __webpack_require__(61);
var quick_e_1 = __webpack_require__(2);
var selectors_instance_1 = __webpack_require__(3);
/**
...
Object.defineProperty(exports, "__esModule", { value: true });
var default_toolbar_template_1 = __webpack_require__(64);
var left_toolbar_template_1 = __webpack_require__(65);
...
Object.defineProperty(exports, "__esModule", { value: true });
var expand_button_config_1 = __webpack_require__(9);
var expand_group_config_1 = __webpack_require__(66);
var toolbar_config_1 = __webpack_require__(68);
var toolbar_settings_1 = __webpack_require__(31);
var toolbar_standard_buttons_1 = __webpack_require__(26);
function ExpandToolbarConfig(context, toolbarData, toolbarSettings) {
    ...
    if (!toolbarData.action && !toolbarData.groups && !toolbarData.buttons && !Array.isArray(toolbarData))
        unstructuredConfig = toolbar_standard_buttons_1.toolbarStandardButtons(context.user.canDesign, toolbarData);
    // whatever we had, if more settings were provided, override with these...
    var config = buildFullDefinition(context, unstructuredConfig, toolbarSettings);
    return config;
}
 ...
 */
var buildFullDefinition = function (context, unstructuredConfig, toolbarSettings) {
    ...
    expand_button_config_1.removeDisableButtons(context, fullConfig);
    if (fullConfig.debug)
...
var settings_adapter_1 = __webpack_require__(67);
...
Object.defineProperty(exports, "__esModule", { value: true });
var create_1 = __webpack_require__(73);
/**
...
Object.defineProperty(exports, "__esModule", { value: true });
var engine_1 = __webpack_require__(18);
var manipulate_1 = __webpack_require__(71);
var context_1 = __webpack_require__(4);
var render_button_1 = __webpack_require__(15);
var render_toolbar_1 = __webpack_require__(14);
var toolbar_expand_config_1 = __webpack_require__(27);
var api_1 = __webpack_require__(1);
var local_storage_helper_1 = __webpack_require__(74);
var button_config_adapter_1 = __webpack_require__(75);
/**
 * A helper-controller in charge of opening edit-dialogues + creating the toolbars for it
 * all in-page toolbars etc.
 * if loaded, it's found under the $2sxc(module).manage
...
var commands_1 = __webpack_require__(6);
var button_action_1 = __webpack_require__(29);
var button_definition_1 = __webpack_require__(76);
var button_config_1 = __webpack_require__(30);
var parameters_adapter_1 = __webpack_require__(28);
var expand_button_config_1 = __webpack_require__(9);
function buttonConfigAdapter(context, actDef, groupIndex) {
    ...
    if (actDef.showCondition) {
        partialButtonConfig.showCondition = function (context, settings) {
            var modConfig = new button_definition_1.ModConfig();
...
Object.defineProperty(exports, "__esModule", { value: true });
var i18next = __webpack_require__(34);
var i18nextXHRBackend = __webpack_require__(35);
var jqueryI18next = __webpack_require__(36);
/**
...
Object.defineProperty(exports, "__esModule", { value: true });
var cb_1 = __webpack_require__(79);
var Mod_1 = __webpack_require__(139);
...
Object.defineProperty(exports, "__esModule", { value: true });
var mod_manage_1 = __webpack_require__(17);
var quick_e_1 = __webpack_require__(2);
var selectors_instance_1 = __webpack_require__(3);
...
Object.defineProperty(exports, "__esModule", { value: true });
var item_commands_1 = __webpack_require__(70);
var command_base_1 = __webpack_require__(0);
/**
...
var commands_1 = __webpack_require__(6);
var context_1 = __webpack_require__(4);
var manage_1 = __webpack_require__(72);
var quick_e_1 = __webpack_require__(2);
var start_1 = __webpack_require__(21);
var _2sxc__translateInit_1 = __webpack_require__(77);
__webpack_require__(78);
...
Object.defineProperty(exports, "__esModule", { value: true });
var Cb_1 = __webpack_require__(142);
var clipboard_1 = __webpack_require__(16);
var quick_e_1 = __webpack_require__(2);
var selectors_instance_1 = __webpack_require__(3);
/**
