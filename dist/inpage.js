...
Object.defineProperty(exports, "__esModule", { value: true });
var action_create_1 = __webpack_require__(18);
...
Object.defineProperty(exports, "__esModule", { value: true });
var toolbar_template_1 = __webpack_require__(26);
/**
...
var toolbar_expand_config_1 = __webpack_require__(53);
...
var generate_button_html_1 = __webpack_require__(13);
var generate_toolbar_html_1 = __webpack_require__(12);
var standard_buttons_1 = __webpack_require__(32);
var toolbar_template_1 = __webpack_require__(33);
/**
 * Toolbar manager for the whole page - basically a set of APIs
 * the toolbar manager is an internal helper taking care of toolbars, buttons etc.
 */
...
var expand_button_config_1 = __webpack_require__(51);
...
Object.defineProperty(exports, "__esModule", { value: true });
var instance_config_1 = __webpack_require__(17);
var buttonHelpers = __webpack_require__(54);
var standard_buttons_1 = __webpack_require__(32);
...
Object.defineProperty(exports, "__esModule", { value: true });
var button_config_1 = __webpack_require__(30);
var Buttonaction = __webpack_require__(29);
 ...
 * @param actions
 */
exports.expandButtonGroups = function (fullToolbarConfig, actions) {
    // by now we should have a structure, let's check/fix the buttons
    for (var g = 0; g < fullToolbarConfig.groups.length; g++) {
        // expand a verb-list like "edit,new" into objects like [{ action: "edit" }, {action: "new"}]
        exports.expandButtonList(fullToolbarConfig.groups[g], fullToolbarConfig.settings, actions);
        // fix all the buttons
 ...
 * @param settings
 */
exports.expandButtonList = function (root, settings, actions) {
    // let root = grp; // the root object which has all params of the command
    var btns = [];
    var sharedProperties = null;
    // convert compact buttons (with multi-verb action objects) into own button-objects
 ...
 * @param actions
 */
exports.addDefaultBtnSettings = function (btn, group, fullToolbarConfig, actions) {
    for (var d = 0; d < exports.btnProperties.length; d++)
        fallbackBtnSetting(btn, group, fullToolbarConfig, actions, exports.btnProperties[d]);
};
/**
 * configure missing button properties with various fallback options
 * @param btn
